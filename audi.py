...
#    #
#    # Preallocate x as a list of lists of Nones
#    #
#    x: list[list[ Optional[Atom] ]] = [
#        [None for _ in range(num_shifts)] for _ in range(num_data_rows)
#    ]
#    #
...
##(
#    equations = (
#        _create_equation_for_evaluator(equation_id, *i) 
#        for equation_id, i in enumerate(zip(equations, diff_sizes))
#    )
