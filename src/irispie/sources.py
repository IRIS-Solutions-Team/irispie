...
class ModelSource:
    ...
    def add_autovalue_definitions(self, equation_inputs: Iterable[EquationInput] | None) -> None:
        self._add_equations(equation_inputs, _equations.EquationKind.AUTOVALUE_DEFINITION, )
    ...
    def from_lists(
        ...
        autovalue_definitions: Iterable[EquationInput] | None = None,
        ...
        self.add_autovalue_definitions(autovalue_definitions, )
    ...
    def from_string(
        ...
        self.add_autovalue_definitions(parsed_content.get("autovalue-definitions"))
